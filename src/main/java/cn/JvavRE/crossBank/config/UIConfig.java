...
public class UIConfig {
    ...
    private static final String DEFAULT_CONTENT = "<color:#5EFFFF>⦿ <color:#00FF9B>{server}</color>  余额: <color:#FFD700>{amount}</color><newline><color:#5EFFFF>├─ </color>{action}</color>";
